...
GLuint	texture[2],texid[2];	// Storage For Our Font Texture
...
bool NeHeLoadBitmap2(LPTSTR szFileName, LPTSTR szFileName1, GLuint *texid)	// Creates Texture From A Bitmap File
{
	HBITMAP hBMP,hBMP1;														// Handle Of The Bitmap
	BITMAP	BMP,BMP1;														// Bitmap Structure
	...
	GetObject(hBMP1, sizeof(BMP1), &BMP1);									// Get The Object
																		// hBMP:        Handle To Graphics Object
																		// sizeof(BMP): Size Of Buffer For Object Information
																		// &BMP:        Buffer For Object Information
...
int LoadGLTextures()                                    // Load Bitmaps And Convert To Textures
{
        ...
        if (NeHeLoadBitmap2("../../Data/Font2.bmp","../../Data/Bumps2.bmp", texture))		// Load The Bitmap
        {
